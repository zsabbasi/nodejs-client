...
class PublicMethodsApiV3 {
    ...
    publicChart(currencyPairId, candlesType, params, cb) {
        this.url = this.url + '/public/chart/' + currencyPairId + '/' + candlesType;
    ...
    publicOrderbook(currencyPairId, params, cb) {
        this.url = this.url + '/public/orderbook/' + currencyPairId;
        this.request(params, function (res) {
            cb(res);
        })
    }
    ...
    publicTrades(currencyPairId, params, cb) {
        this.url = this.url + '/public/trades/' + currencyPairId;
        this.request(params, function (res) {
            cb(res);
        })
    }
    ...
    publicTicker(currencyPairId, cb) {
        this.url = this.url + '/public/ticker/' + currencyPairId;
        this.request({}, function (res) {
            cb(res);
        })
    }
    ...
    allPublicTicker(cb) {
        this.url = this.url + '/public/ticker';
        this.request({}, function (res) {
            cb(res);
        })
    }
    ...
    publicCurrencyPairsById(currencyPairId, cb) {
        this.url = this.url + '/public/currency_pairs/' + currencyPairId;
        this.request({}, function (res) {
            cb(res);
        })
    }
    ...
    publicCurrencyPairsListByCode(code, cb) {
        this.url = this.url + '/public/currency_pairs/list/' + code;
        this.request({}, function (res) {
            cb(res);
        })
    }
    ...
    publicMarkets(cb) {
        this.url = this.url + '/public/markets';
        this.request({}, function (res) {
            cb(res);
        })
    }
    ...
    publicCurrencyById(currencyId, cb) {
        this.url = this.url + '/public/currencies/' + currencyId;
        this.request({}, function (res) {
            cb(res);
        })
    }
    ...
    publicCurrency(cb) {
        this.url = this.url + '/public/currencies';
        this.request({}, function (res) {
            cb(res);
        })
    }
