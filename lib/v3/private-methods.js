...
class PrivateMethodsApiV3 {
    ...
    profileWithdrawalCancelById(id, cb) {
        this.url = this.url + '/profile/withdraw/' + id;
        this.request({}, function (res) {
            cb(res);
        }, 'DELETE')
    }
    ...
    getReportsOrders(params, cb) {
        this.url = this.url + '/reports/orders';
        this.request(params, function (res) {
            cb(res);
        })
    }
    ...
    getReportsOrdersById(id, cb) {
        this.url = this.url + '/reports/orders/' + id;
        this.request({}, function (res) {
            cb(res);
        })
    }
    ...
    getTradingOrders(cb) {
        this.url = this.url + '/trading/orders';
        this.request({}, function (res) {
            cb(res);
        })
    }
    ...
    getTradingOrdersById(id, cb) {
        this.url = this.url + '/trading/orders/' + id;
        this.request({}, function (res) {
            cb(res);
        })
    }
    ...
    tradingOrderByOrderId(id, cb) {
        this.url = this.url + '/trading/order/' + id;
        this.request({}, function (res) {
            cb(res);
        })
    }
